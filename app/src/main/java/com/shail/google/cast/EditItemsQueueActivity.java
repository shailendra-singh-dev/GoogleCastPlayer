...
public class EditItemsQueueActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preloadTimeRow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DialogFragment dialog = new CastTextEditDialog(R.string.enter_preload_time) {
                    @Override
                    protected void onDialogPositiveClick(String text) {
        ...
        playbackDurationRow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DialogFragment dialog = new CastTextEditDialog(R.string.enter_playback_duration) {
                    @Override
                    protected void onDialogPositiveClick(String text) {
