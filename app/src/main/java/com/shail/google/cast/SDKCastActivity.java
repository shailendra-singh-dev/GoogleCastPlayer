...
public class SDKCastActivity extends BaseCastActivity {
    private static final String TAG = "SDKCastActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoadQueueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SDKCastActivity.this, CastQueueLoadActivity.class);
        ...
        mInsertQueueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =
                        new Intent(SDKCastActivity.this, CastQueueInsertItemsActivity.class);
                putExtraMediaStatus(mMediaPlayer.getMediaStatus(), intent);
        ...
        mUpdateQueueButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SDKCastActivity.this,
                        CastQueueUpdateItemsActivity.class);
                putExtraMediaStatus(mMediaPlayer.getMediaStatus(), intent);
        ...
        mRemoveQueueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SDKCastActivity.this,
                        CastQueueRemoveItemsActivity.class);
                putExtraMediaStatus(mMediaPlayer.getMediaStatus(), intent);
        ...
        mQueueJumpButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SDKCastActivity.this, CastQueueJumpActivity.class);
                putExtraMediaStatus(mMediaPlayer.getMediaStatus(), intent);
        ...
        mQueueInsertAndPlayItemButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SDKCastActivity.this,
                        CastQueueInsertAndPlayItemActivity.class);
                putExtraMediaStatus(mMediaPlayer.getMediaStatus(), intent);
    ...
    private void putExtraMediaStatus(final MediaStatus mediaStatus, Intent intent) {
        ...
        intent.putExtra(CastQueueLoadActivity.EXTRA_REPEAT_MODE, mediaStatus.getQueueRepeatMode());
        ...
        intent.putExtra(CastQueueLoadActivity.EXTRA_ITEMS, itemStrings);
        intent.putExtra(CastQueueJumpActivity.EXTRA_CURRENT_ITEM_ID, mediaStatus.getCurrentItemId());
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case RESULT_CODE_QUEUE_LOAD: {
                String[] jsonItems = data.getStringArrayExtra(CastQueueLoadActivity.EXTRA_ITEMS);
                ...
                int repeatMode = data.getIntExtra(CastQueueLoadActivity.EXTRA_REPEAT_MODE,
                        MediaStatus.REPEAT_MODE_REPEAT_ALL);
                int startIndex = data.getIntExtra(CastQueueLoadActivity.EXTRA_START_INDEX, 0);
                if (data.hasExtra(CastQueueJumpActivity.EXTRA_START_TIME)) {
                    double startTime = data.getDoubleExtra(CastQueueJumpActivity.EXTRA_START_TIME, 0);
            ...
            case RESULT_CODE_QUEUE_INSERT: {
                String[] jsonItems = data.getStringArrayExtra(CastQueueInsertItemsActivity.EXTRA_ITEMS);
                int insertBeforeItemId =
                        data.getIntExtra(CastQueueInsertItemsActivity.EXTRA_INSERT_BEFORE_ITEM_ID,
            ...
            case RESULT_CODE_QUEUE_UPDATE: {
                String[] jsonItems = data.getStringArrayExtra(CastQueueUpdateItemsActivity.EXTRA_ITEMS);
                MediaQueueItem[] items = new MediaQueueItem[jsonItems.length];
                for (int i = 0; i < jsonItems.length; ++i) {
                    try {
                        items[i] = new MediaQueueItem.Builder(new JSONObject(jsonItems[i])).build();
            ...
            case RESULT_CODE_QUEUE_REMOVE: {
                int[] itemIdsToRemove =
                        data.getIntArrayExtra(CastQueueRemoveItemsActivity.EXTRA_ITEM_IDS);
            ...
            case RESULT_CODE_QUEUE_JUMP: {
                int currentItemId = data.getIntExtra(CastQueueJumpActivity.EXTRA_CURRENT_ITEM_ID, 0);
                if (data.hasExtra(CastQueueJumpActivity.EXTRA_START_TIME)) {
                    double startTime = data.getDoubleExtra(CastQueueJumpActivity.EXTRA_START_TIME, 0);
            ...
            case RESULT_CODE_QUEUE_INSERT_AND_PLAY: {
                String jsonItem =
                        data.getStringExtra(CastQueueInsertAndPlayItemActivity.EXTRA_INSERTED_ITEM);
                ...
                public void run() {
                    ...
                    if (mResolvingError) {
                        ...
                        try {
                            ...
                            result.startResolutionForResult(SDKCastActivity.this,
