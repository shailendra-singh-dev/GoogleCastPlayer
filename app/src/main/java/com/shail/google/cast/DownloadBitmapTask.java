...
public abstract class DownloadBitmapTask extends AsyncTask<Uri, Void, Bitmap> {
    private final int mPreferredWidth;
    private final int mPreferredHeight;

    /**
     * Constructs a new DownloadBitmapTask that will do scaling.
     *
     * @param preferredWidth The preferred image width.
     * @param preferredHeight The preferred image height.
     */
    public DownloadBitmapTask(int preferredWidth, int preferredHeight) {
        mPreferredWidth = preferredWidth;
        mPreferredHeight = preferredHeight;
    }

    /**
     * Constructs a new DownloadBitmapTask.
     */
