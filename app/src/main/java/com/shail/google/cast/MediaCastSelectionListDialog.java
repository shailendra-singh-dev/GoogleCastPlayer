...
abstract class MediaCastSelectionListDialog extends CastSelectionListDialog<MediaInfo> {
    ...
    private static final String TAG = "MediaCastSelectionListDialog";

    private final Context mContext;

    public MediaCastSelectionListDialog(Context context) {
    ...
    protected ArrayAdapter<MediaInfo> buildAdapter() {
        return new CastMediaAdapter(mContext);
    }
